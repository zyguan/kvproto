...
type DispatchTaskRequest struct {
	...
	FineGrainedShuffleStreamCount uint32                      `protobuf:"varint,7,opt,name=fine_grained_shuffle_stream_count,json=fineGrainedShuffleStreamCount,proto3" json:"fine_grained_shuffle_stream_count,omitempty"`
	FineGrainedShuffleBatchSize   uint64                      `protobuf:"varint,8,opt,name=fine_grained_shuffle_batch_size,json=fineGrainedShuffleBatchSize,proto3" json:"fine_grained_shuffle_batch_size,omitempty"`
	XXX_NoUnkeyedLiteral          struct{}                    `json:"-"`
	XXX_unrecognized              []byte                      `json:"-"`
	XXX_sizecache                 int32                       `json:"-"`
}
...
func (m *DispatchTaskRequest) GetFineGrainedShuffleStreamCount() uint32 {
	if m != nil {
...
func (m *DispatchTaskRequest) GetFineGrainedShuffleBatchSize() uint64 {
	if m != nil {
...
type MPPDataPacket struct {
	...
	StreamIds            []uint32 `protobuf:"varint,4,rep,packed,name=stream_ids,json=streamIds,proto3" json:"stream_ids,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *MPPDataPacket) GetStreamIds() []uint32 {
	if m != nil {
		return m.StreamIds
	}
	return nil
...
var fileDescriptor_819623c7fa76fc55 = []byte{
	...
	,
}
...
func (m *DispatchTaskRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if m.FineGrainedShuffleBatchSize != 0 {
		i = encodeVarintMpp(dAtA, i, uint64(m.FineGrainedShuffleBatchSize))
		i--
		dAtA[i] = 0x40
	}
	if m.FineGrainedShuffleStreamCount != 0 {
		i = encodeVarintMpp(dAtA, i, uint64(m.FineGrainedShuffleStreamCount))
		i--
		dAtA[i] = 0x38
	}
...
func (m *DispatchTaskRequest) Size() (n int) {
	...
	if m.FineGrainedShuffleStreamCount != 0 {
		n += 1 + sovMpp(uint64(m.FineGrainedShuffleStreamCount))
	}
	if m.FineGrainedShuffleBatchSize != 0 {
		n += 1 + sovMpp(uint64(m.FineGrainedShuffleBatchSize))
	}
	if m.XXX_unrecognized != nil {
		n += len(m.XXX_unrecognized)
	}
	...
	for iNdEx < l {
		...
		case 7:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FineGrainedShuffleStreamCount |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
