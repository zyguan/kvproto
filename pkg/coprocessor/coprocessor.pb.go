...
import (
	...
	github_com_pingcap_kvproto_pkg_util "github.com/pingcap/kvproto/pkg/util"
)
...
type Response struct {
	...
	ExecDetails github_com_pingcap_kvproto_pkg_util.DeprecatedField `protobuf:"bytes,6,opt,name=exec_details,json=execDetails,proto3,customtype=github.com/pingcap/kvproto/pkg/util.DeprecatedField" json:"exec_details"`
	...
	BatchResponses       []github_com_pingcap_kvproto_pkg_sharedbytes.SharedBytes `protobuf:"bytes,13,rep,name=batch_responses,json=batchResponses,proto3,customtype=github.com/pingcap/kvproto/pkg/sharedbytes.SharedBytes" json:"batch_responses"`
	XXX_NoUnkeyedLiteral struct{}                                                 `json:"-"`
	XXX_unrecognized     []byte                                                   `json:"-"`
	XXX_sizecache        int32                                                    `json:"-"`
}
...
type BatchResponse struct {
	...
	ExecDetails          github_com_pingcap_kvproto_pkg_util.DeprecatedField    `protobuf:"bytes,3,opt,name=exec_details,json=execDetails,proto3,customtype=github.com/pingcap/kvproto/pkg/util.DeprecatedField" json:"exec_details"`
...
var fileDescriptor_29878c170c3dd019 = []byte{
	...
	,
}
...
func (m *Response) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.BatchResponses) > 0 {
		for iNdEx := len(m.BatchResponses) - 1; iNdEx >= 0; iNdEx-- {
			{
				size := m.BatchResponses[iNdEx].Size()
				i -= size
				if _, err := m.BatchResponses[iNdEx].MarshalTo(dAtA[i:]); err != nil {
					return 0, err
				}
				i = encodeVarintCoprocessor(dAtA, i, uint64(size))
			}
...
func (m *Response) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 13:
			...
			m.BatchResponses = append(m.BatchResponses, github_com_pingcap_kvproto_pkg_sharedbytes.SharedBytes{})
