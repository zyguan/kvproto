...
type IncompatibleRequestReason int32

const (
	IncompatibleRequestReason_IncompatibleRequestReasonUnknown IncompatibleRequestReason = 0
	// The declared version is outside the compatible range returned in the error.
	IncompatibleRequestReason_IncompatibleRequestReasonTxnProtocolVersionOutOfRange IncompatibleRequestReason = 1
)

var IncompatibleRequestReason_name = map[int32]string{
	0: "IncompatibleRequestReasonUnknown",
	1: "IncompatibleRequestReasonTxnProtocolVersionOutOfRange",
}

var IncompatibleRequestReason_value = map[string]int32{
	"IncompatibleRequestReasonUnknown":                      0,
	"IncompatibleRequestReasonTxnProtocolVersionOutOfRange": 1,
}

func (x IncompatibleRequestReason) String() string {
	return proto.EnumName(IncompatibleRequestReason_name, int32(x))
}

func (IncompatibleRequestReason) EnumDescriptor() ([]byte, []int) {
...
type IncompatibleRequest struct {
	Reason IncompatibleRequestReason `protobuf:"varint,1,opt,name=reason,proto3,enum=errorpb.IncompatibleRequestReason" json:"reason,omitempty"`
	...
	ProvidedTxnProtocolVersion      uint32 `protobuf:"varint,3,opt,name=provided_txn_protocol_version,json=providedTxnProtocolVersion,proto3" json:"provided_txn_protocol_version,omitempty"`
	MinCompatibleTxnProtocolVersion uint32 `protobuf:"varint,4,opt,name=min_compatible_txn_protocol_version,json=minCompatibleTxnProtocolVersion,proto3" json:"min_compatible_txn_protocol_version,omitempty"`
	MaxCompatibleTxnProtocolVersion uint32 `protobuf:"varint,5,opt,name=max_compatible_txn_protocol_version,json=maxCompatibleTxnProtocolVersion,proto3" json:"max_compatible_txn_protocol_version,omitempty"`
}

func (m *IncompatibleRequest) Reset()         { *m = IncompatibleRequest{} }
func (m *IncompatibleRequest) String() string { return proto.CompactTextString(m) }
func (*IncompatibleRequest) ProtoMessage()    {}
func (*IncompatibleRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_390aa86757fd1154, []int{9}
}
func (m *IncompatibleRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *IncompatibleRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_IncompatibleRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *IncompatibleRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_IncompatibleRequest.Merge(m, src)
}
func (m *IncompatibleRequest) XXX_Size() int {
	return m.Size()
}
func (m *IncompatibleRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_IncompatibleRequest.DiscardUnknown(m)
}

var xxx_messageInfo_IncompatibleRequest proto.InternalMessageInfo

func (m *IncompatibleRequest) GetReason() IncompatibleRequestReason {
	if m != nil {
		return m.Reason
	}
	return IncompatibleRequestReason_IncompatibleRequestReasonUnknown
}

func (m *IncompatibleRequest) GetMessage() string {
	if m != nil {
		return m.Message
	}
	return ""
...
func (m *IncompatibleRequest) GetProvidedTxnProtocolVersion() uint32 {
	if m != nil {
		return m.ProvidedTxnProtocolVersion
	}
	return 0
}

func (m *IncompatibleRequest) GetMinCompatibleTxnProtocolVersion() uint32 {
	if m != nil {
		return m.MinCompatibleTxnProtocolVersion
	}
	return 0
}

func (m *IncompatibleRequest) GetMaxCompatibleTxnProtocolVersion() uint32 {
	if m != nil {
		return m.MaxCompatibleTxnProtocolVersion
	}
	return 0
}
...
type Error struct {
	...
	// Only client-c may reselect and resend when the reason is version out of range,
	...
	IncompatibleRequest *IncompatibleRequest `protobuf:"bytes,23,opt,name=incompatible_request,json=incompatibleRequest,proto3" json:"incompatible_request,omitempty"`
}
...
func (*Error) Descriptor() ([]byte, []int) {
	return fileDescriptor_390aa86757fd1154, []int{22}
}
...
func (m *Error) GetIncompatibleRequest() *IncompatibleRequest {
	if m != nil {
		return m.IncompatibleRequest
	}
	return nil
}

func init() {
	proto.RegisterEnum("errorpb.IncompatibleRequestReason", IncompatibleRequestReason_name, IncompatibleRequestReason_value)
	...
	proto.RegisterType((*IncompatibleRequest)(nil), "errorpb.IncompatibleRequest")
...
var fileDescriptor_390aa86757fd1154 = []byte{
	...
	,
}
...
func (m *IncompatibleRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *IncompatibleRequest) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *IncompatibleRequest) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.MaxCompatibleTxnProtocolVersion != 0 {
		i = encodeVarintErrorpb(dAtA, i, uint64(m.MaxCompatibleTxnProtocolVersion))
		i--
		dAtA[i] = 0x28
	}
	if m.MinCompatibleTxnProtocolVersion != 0 {
		i = encodeVarintErrorpb(dAtA, i, uint64(m.MinCompatibleTxnProtocolVersion))
		i--
		dAtA[i] = 0x20
	}
	if m.ProvidedTxnProtocolVersion != 0 {
		i = encodeVarintErrorpb(dAtA, i, uint64(m.ProvidedTxnProtocolVersion))
		i--
		dAtA[i] = 0x18
	}
	if len(m.Message) > 0 {
	...
	if m.Reason != 0 {
		i = encodeVarintErrorpb(dAtA, i, uint64(m.Reason))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *Error) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.IncompatibleRequest != nil {
		{
			size, err := m.IncompatibleRequest.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *IncompatibleRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	_ = l
	if m.Reason != 0 {
		n += 1 + sovErrorpb(uint64(m.Reason))
	}
	l = len(m.Message)
	if l > 0 {
		n += 1 + l + sovErrorpb(uint64(l))
	...
	if m.ProvidedTxnProtocolVersion != 0 {
		n += 1 + sovErrorpb(uint64(m.ProvidedTxnProtocolVersion))
	}
	if m.MinCompatibleTxnProtocolVersion != 0 {
		n += 1 + sovErrorpb(uint64(m.MinCompatibleTxnProtocolVersion))
	}
	if m.MaxCompatibleTxnProtocolVersion != 0 {
		n += 1 + sovErrorpb(uint64(m.MaxCompatibleTxnProtocolVersion))
	}
	return n
}
...
func (m *IncompatibleRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: IncompatibleRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: IncompatibleRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Reason |= IncompatibleRequestReason(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ProvidedTxnProtocolVersion", wireType)
			}
			m.ProvidedTxnProtocolVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowErrorpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProvidedTxnProtocolVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 4:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MinCompatibleTxnProtocolVersion", wireType)
			}
			m.MinCompatibleTxnProtocolVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowErrorpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MinCompatibleTxnProtocolVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 5:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field MaxCompatibleTxnProtocolVersion", wireType)
			}
			m.MaxCompatibleTxnProtocolVersion = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowErrorpb
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.MaxCompatibleTxnProtocolVersion |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Error) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 23:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IncompatibleRequest", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.IncompatibleRequest == nil {
				m.IncompatibleRequest = &IncompatibleRequest{}
			}
			if err := m.IncompatibleRequest.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
